...
import (
	...
	commonmocks "github.com/O1MaGnUmO1/erinaceus-vrf/common/types/mocks"
	...
	webpresenters "github.com/O1MaGnUmO1/erinaceus-vrf/core/web/presenters"
	"github.com/O1MaGnUmO1/erinaceus-vrf/plugins"

	// Force import of pgtest to ensure that txdb is registered as a DB driver
	_ "github.com/O1MaGnUmO1/erinaceus-vrf/core/internal/testutils/pgtest"
)
...
func NewJobPipelineV2(t testing.TB, cfg pipeline.BridgeConfig, jpcfg JobPipelineConfig, dbCfg pg.QConfig, legacyChains legacyevm.LegacyChainContainer, db *sqlx.DB, keyStore keystore.Master, restrictedHTTPClient, unrestrictedHTTPClient *http.Client) JobPipelineV2TestHelper {
	...
	pr := pipeline.NewRunner(prm, btORM, jpcfg, cfg, legacyChains, keyStore.VRF(), lggr, restrictedHTTPClient, unrestrictedHTTPClient)
