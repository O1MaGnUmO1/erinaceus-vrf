...
import (
	...
	gasmocks "github.com/O1MaGnUmO1/erinaceus-vrf/core/chains/evm/gas/mocks"
...
func TestEthBroadcaster_ProcessUnstartedEthTxs_Errors(t *testing.T) {
	...
	t.Run("eth node returns underpriced transaction and bumping gas doesn't increase it", func(t *testing.T) {
		...
		// validation)
		evmcfg2 := evmtest.NewChainScopedConfig(t, configtest.NewGeneralConfig(t, func(c *erinaceus.Config, s *erinaceus.Secrets) {
