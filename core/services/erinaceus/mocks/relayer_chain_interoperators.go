...
// FakeRelayerChainInteroperators is a fake erinaceus.RelayerChainInteroperators.
...
func (f *FakeRelayerChainInteroperators) List(filter erinaceus.FilterFn) erinaceus.RelayerChainInteroperators {
	panic("unimplemented")
}
