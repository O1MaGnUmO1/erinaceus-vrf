...
import (
	...
	evmlogger "github.com/O1MaGnUmO1/erinaceus-vrf/core/chains/evm/log"
	...
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/batch_blockhash_store"
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/batch_vrf_coordinator_v2"
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/blockhash_store"
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/link_token_interface"
	...
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/vrf_external_sub_owner_example"
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/vrf_malicious_consumer_v2"
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/vrf_owner"
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/vrf_single_consumer_example"
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/vrfv2_reverting_example"
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/vrfv2_wrapper"
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/gethwrappers/generated/vrfv2_wrapper_consumer_example"
	...
	"github.com/O1MaGnUmO1/erinaceus-vrf/core/services/vrf/proof"
...
func newVRFCoordinatorV2Universe(t *testing.T, key ethkey.KeyV2, numConsumers int) coordinatorV2Universe {
	...
	coordinatorAddress, _, coordinatorContract, err :=
		vrf_coordinator_v2.DeployVRFCoordinatorV2(
			neil, backend, linkAddress, bhsAddress /* linkEth*/)
	...
	oldRootContractAddress, oldRootContract := deployOldCoordinator(
		t, linkAddress, bhsAddress, backend, neil)
...
func deployOldCoordinator(
	...
	*vrf_coordinator_v2.VRFCoordinatorV2,
	...
	ctorArgs, err := evmutils.ABIEncode(`[{"type":"address"}, {"type":"address"}, {"type":"address"}]`, bhsAddress, linkEthFeed)
	require.NoError(t, err)
...
func TestExternalOwnerConsumerExample(t *testing.T) {
	...
	coordinatorAddress, _, coordinator, err :=
		vrf_coordinator_v2.DeployVRFCoordinatorV2(
			owner, backend, common.Address{}, common.Address{})
	require.NoError(t, err)
